...
export default {
  ...
  methods: {
    ...
    // 校验邮箱
    checkEmailMethod () {
      this.$http.post('/api/ajax/checkemail', { email: this.ruleForm.email }, { headers: { 'Content-Type': 'application/x-www-form-urlencoded' } }).then(function (response) {
